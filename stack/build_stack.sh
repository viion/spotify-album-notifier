...
echo "mysql-server mysql-server/root_password password test" | debconf-set-selections
echo "mysql-server mysql-server/root_password_again password test" | debconf-set-selections
sudo apt install mysql-server -y
mysql -uroot -ptest < ./mysql/db.sql
